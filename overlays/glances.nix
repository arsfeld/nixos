...
#   - tests/test_restful.py / tests/test_xmlrpc.py: spin up a Glances server and
#     connect to it over localhost, which the network-less sandbox refuses
#     (ConnectionError / ConnectionRefusedError). Drop both modules.
final: prev: {
